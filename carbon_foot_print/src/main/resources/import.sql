...
INSERT INTO permissions(idPermission, name, description) VALUES (205, "ROLE_Listar_Voluntario_Posicion","Permiso para listar voluntarios por posicion en el sistema");
...
INSERT INTO permissions(idPermission, name, description) VALUES (303, "ROLE_Consultar_Empresa","Permiso para consultar una empresa en el sistema");
INSERT INTO permissions(idPermission, name, description) VALUES (304, "ROLE_Consultar_Empresa_NIT","Permiso para consultar una empresa por NIT");
INSERT INTO permissions(idPermission, name, description) VALUES (305, "ROLE_Consultar_Empresa_Documento","Permiso para consultar una empresa por numero de documento");
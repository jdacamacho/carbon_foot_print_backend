...
public interface ManagePollutionSourceGatewayIntPort {
    ...
    /**
     * Obtiene una lista de todas las fuentes de contaminación.
     * 
     ...
     * 
     * @param idPollutionSources Una lista de identificadores de fuentes de contaminación. No debe ser null.

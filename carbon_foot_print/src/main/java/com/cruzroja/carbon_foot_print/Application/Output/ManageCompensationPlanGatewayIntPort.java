 ...
 *        planes de compensación en el gateway de la aplicación.
 * 
 *        Esta interfaz proporciona los métodos necesarios para interactuar con
 *        el sistema de almacenamiento de datos
 *        para crear, actualizar, recuperar y gestionar planes de compensación y
...
public interface ManageCompensationPlanGatewayIntPort {
    ...
    /**
     * @brief Verifica si existe un plan de compensación con un identificador
     *        específico.
     * 
     *        Este método comprueba la existencia de un plan de compensación
     *        utilizando su identificador único.
     * 
     * @param planId El identificador único del plan de compensación cuya existencia
     *               se desea verificar.
     ...
     * 
     * @param planName El nombre del plan de compensación cuya existencia se desea
     *                 verificar.
     * @return true si el plan de compensación existe, false en caso contrario.
     */
     ...
     * 
     *        Este método devuelve una lista de todas las acciones relacionadas con
     *        los planes de compensación almacenadas en el sistema.
     * 
     * @return Una lista de objetos de tipo Action que representan todas las
     *         acciones.
     */

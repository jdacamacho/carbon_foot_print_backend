 ...
 */
  ...
  * @brief Interfaz que define las operaciones de caso de uso para la gestión de planes de compensación.
  * 
  * Esta interfaz proporciona los métodos necesarios para crear, actualizar, recuperar y gestionar planes de compensación en la aplicación.
  */
 public interface ManageCompensationPlanCUIntPort {
      ...
      * @throws BadFormatException Si el formato del plan de compensación es incorrecto.
      ...
      * 
      * @param compensationPlan El objeto CompensationPlan que contiene los datos actualizados.

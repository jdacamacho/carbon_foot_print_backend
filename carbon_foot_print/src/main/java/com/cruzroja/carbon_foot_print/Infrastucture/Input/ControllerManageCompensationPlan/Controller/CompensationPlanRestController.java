 ...
 */
  ...
  * @brief Controlador REST para gestionar los planes de compensación.
  * 
  * Este controlador proporciona endpoints para crear, actualizar, recuperar y listar los planes de compensación.
  */
 ...
 public class CompensationPlanRestController {
      ...
      * 
      * @return Una lista de objetos CompensationPlanDTOResponse con los planes de compensación.
      */
     @GetMapping("")
      ...
      * @return El objeto CompensationPlanDTOResponse correspondiente al ID proporcionado.
      */
      ...
      * @return El objeto CompensationPlanDTOResponse correspondiente al nombre proporcionado.
      */
     @GetMapping("/name")
     @Transactional(readOnly = true)
      ...
      * 
      * @param request El objeto CompensationPlanDTORequest con los datos del plan de compensación a guardar.
      * @param result El resultado de la validación del objeto de solicitud.
      * @return El objeto CompensationPlanDTOResponse guardado, o un error si ocurre algún problema.
      */
     @PostMapping("")
      ...
      * 
      * @param request El objeto CompensationPlanWithIdDTORequest con los datos del plan de compensación a actualizar.
      * @param result El resultado de la validación del objeto de solicitud.
      * @return El objeto CompensationPlanDTOResponse actualizado, o un error si ocurre algún problema.
      */
     @PutMapping("")
